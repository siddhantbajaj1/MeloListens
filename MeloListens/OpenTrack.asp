...
b=cdbl(request.querystring("TrackID"))
...
<html>
	...
	<body background="images\bgm.jpg" link="brown" vlink="brown" alink="#ff9f00">
		...
		<table align=right border=2><tr><td><embed src=Ads\rummy.swf height=200></td><td><embed src=Ads\listen.swf height=200></td></tr></table>
		...
		<table border=1 align=right width=50%><td><table>
			<tr><th colspan=2 bgcolor=yellow align=center><%=TrackName%>
			<tr><th colspan=2 align=center><img src=images\<%=Art%>.jpg>
			<tr><th colspan=2 bgcolor=yellow align=center>Song by <a href=OpenArtistbyname.asp?Artist=<%=ArtistLinked%>><%=Artist%></a>
	...
	<table align=right><th><br><br><br>Listen to sample:<br><embed src=tracks\<%=sample%>.mp3><br></table>
